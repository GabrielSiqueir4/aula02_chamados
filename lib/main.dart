              ...
              child: Column(
                children: [
                  ...
                  decoration: InputDecoration(
                      hintText: "Insira o nome do chamado", label: Text("Nome")),
                  onChanged: (value) {
                    _refreshStateBasics(nome: value);
                  },
                ),
                TextField(
                                ...
                                return Row(
                                  children: [
                                    Checkbox(
                                      value: _selecionado,
                                      onChanged: (value) {
                                        _refreshStateMaterais(_material, value!);
                  ...
                  ElevatedButton(child: Text("Cadastrar"), onPressed: cadastrar),
                  Padding(
                    padding: EdgeInsets.all(15),
                    child: Column(
                      children: [
                        Divider(),
                        Text(' Total de ${chamados.length} chamados cadastrados'),
                        ListView.builder(
                          scrollDirection: Axis.vertical,
                          shrinkWrap: true,
